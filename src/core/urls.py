...
urlpatterns = [
    ...
    path("orientacao/", views.specialty_chat, name="specialty-chat"),
    path("orientacao/enviar/", views.specialty_chat_send, name="specialty-chat-send"),
    path("orientacao/limpar/", views.specialty_chat_reset, name="specialty-chat-reset"),
